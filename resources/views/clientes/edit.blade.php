        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    <h5 class="mb-0">Editar Cliente: {{ $cliente->razon_social }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('clientes.update', $cliente) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="ruc_dni" id="ruc_dni" class="form-control @error('ruc_dni') is-invalid @enderror" value="{{ old('ruc_dni', $cliente->ruc_dni) }}" maxlength="11" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="razon_social" id="razon_social" class="form-control @error('razon_social') is-invalid @enderror" value="{{ old('razon_social', $cliente->razon_social) }}" required>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Actualizar Cliente</button>
                        </div>
                    </form>
                </div>
            </div>
